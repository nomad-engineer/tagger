...
class Database:
    ...
    def create_schema(self):
        ...
        # Media table - stores all media items (images, masks, video frames)
        cursor.execute("""
            CREATE TABLE IF NOT EXISTS media (
                hash TEXT PRIMARY KEY,
                type TEXT NOT NULL CHECK(type IN ('image', 'mask', 'video_frame')),
                source_media TEXT,  -- For masks and video frames: hash of source image/video
                name TEXT,
                caption TEXT,
                created DATETIME,
                modified DATETIME,
